...
export default function Categories() {
    ...
    const { categories, sections, setSections, loadCategories, loadSections, loading }
        = useLoadData(setProducts, "categories");
                                    ...
                                    <div className="rounded-sm overflow-hidden w-full">
                                        ...
                                        <DragDropContext onDragEnd={handleDragEnd}>
                                            <Droppable droppableId="sections">
                                                {(droppableProvided) => (
                                                    <div className="rounded-sm overflow-hidden" ref={droppableProvided.innerRef} {...droppableProvided.droppableProps}>
                                                            ...
                                                            <Draggable key={section._id} draggableId={section._id} index={index}>
                                                                {(provided, snapshot) => (
                                                                    <div
                                                                        ...
                                                                        <Tab
                                                                            key={section._id}
                                                                            className={`flex tab text-sm focus:outline-none odd:bg-gray-4 even:bg-white cursor-pointer transition 
